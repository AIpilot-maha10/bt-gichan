...
### 5상대 로스터로 재검증 (n=20, 시드 50000)

머리맞대기 결과 때문에 상대를 5개로 넓혀 v7.1과 다시 비교했다.

| 상대 | v7.1 승 | v7.2 승 | v7.1 적체력 | v7.2 적체력 |
|---|---|---|---|---|
| btjegal | 11 | **16** | 0.252 | **0.126** |
| jegalmin | 0 | 0 | 0.979 | **0.958** |
| gichan_v6 | 0 | **1** | 0.937 | **0.877** |
| **coordfix** | **6** | 2 | **0.403** | 0.840 |
| BASE | 0 | 0 | 1.000 | 1.000 |
| **합계** | **17** | **19** | | |

**적체력 기준 5상대 중 3승 1패 1무 → v7.2 유지가 맞다.**

⚠️ **단, 우위가 얇다.** "신규 시드 btjegal 승 20→32"는 **한 상대 기준**이었고,
5상대로 넓히면 17 vs 19다. `coordfix`에서는 6→2로 크게 지고 v7.1 머리맞대기도 진다.
**BASE는 상대로 무의미하다**(양쪽 0승, 적체력 1.000).
