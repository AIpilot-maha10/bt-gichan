...
| gichan_v1 | **1** | 0 | **0.942** | 1.000 |
| **합계** | **12** | **17** | | |

**v7.2가 명확히 앞선다** — 승 17 vs 12, 적체력 4상대 중 3승 1패.
**롤백 근거 없음.**

⚠️ 남은 이상점: v7.1과의 **머리맞대기**만은 v7.2가 3승 16패로 진다(원인 미규명).
다만 외부 상대 전반에서는 v7.2가 낫다.

<details><summary>이전에 잘못 보고한 내용 (기록용)</summary>

| 시점 | 보고 | 문제 |
|---|---|---|
| 처음 | "btjegal 승 20→32" | **한 상대**를 전체로 대표 (과대) |
| 다음 | "17 vs 19 얇은 우위" | **퇴화 열** 포함 (과소) — coordfix 열은 v7.1이 자기 자신과 붙은 것이고 BASE는 무기력 상대다 |

</details>

### (참고) 5상대 로스터 원본 (n=20, 시드 50000)
